#ifndef DPA_MATH_DISTRIBUTIONS_MULTIVARIATE_UNIFORM_DISTRIBUTION_HPP
#define DPA_MATH_DISTRIBUTIONS_MULTIVARIATE_UNIFORM_DISTRIBUTION_HPP
...
public:
  ...
  {
  public:
    using distribution_type = multivariate_uniform_distribution;
  ...
  explicit multivariate_uniform_distribution  (const std::array<result_element_type, 2>&                                   bounds = {result_element_type(0), result_element_type(1)}) 
  : parameters_(bounds)
  {
  
  }
  explicit multivariate_uniform_distribution  (const std::initializer_list<result_element_type>&                           bounds) 
  : parameters_(bounds)
  {

  }
  explicit multivariate_uniform_distribution  (const std::array<std::array<result_element_type, 2>, result_element_count>& bounds) 
  : parameters_(bounds)
  {
  
  }
  explicit multivariate_uniform_distribution  (const std::initializer_list<std::initializer_list<result_element_type>>&    bounds) 
  : parameters_(bounds)
  {

  }
  explicit multivariate_uniform_distribution  (const param_type& parameters)
  : parameters_(parameters)
  {                                        
                                           
  }                                        
  multivariate_uniform_distribution           (const multivariate_uniform_distribution&  that) = default;
  multivariate_uniform_distribution           (      multivariate_uniform_distribution&& temp) = default;
 ~multivariate_uniform_distribution           ()                                               = default;
  multivariate_uniform_distribution& operator=(const multivariate_uniform_distribution&  that) = default;
  multivariate_uniform_distribution& operator=(      multivariate_uniform_distribution&& temp) = default;
...
bool operator==(const multivariate_uniform_distribution<type>& lhs, const multivariate_uniform_distribution<type>& rhs)
{
...
std::basic_ostream<stream_type, stream_traits>& operator<<(std::basic_ostream<stream_type, stream_traits>& stream, const multivariate_uniform_distribution<type>& distribution)
{
...
template<typename stream_type, typename stream_traits, typename type>
std::basic_istream<stream_type, stream_traits>& operator>>(std::basic_istream<stream_type, stream_traits>& stream,       multivariate_uniform_distribution<type>& distribution)
{
  std::array<std::array<typename multivariate_uniform_distribution<type>::result_element_type, 2>, multivariate_uniform_distribution<type>::result_element_count> bounds;
