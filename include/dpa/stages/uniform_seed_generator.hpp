...
{
public:
  static std::vector<particle<vector3, integer>> generate(const vector3& offset, const vector3& size, const vector3& stride, integer iterations, integer process_index, std::optional<aabb3> aabb = std::nullopt);
